...
### All (Default)
```
Find-InventoryUpdateJob [-OrderBy <String[]>] [-Search <String[]>] [-Filter <NameValueCollection>]
...
### PipelineVariable
```
Find-InventoryUpdateJob [-Resource] <IResource> [-OrderBy <String[]>] [-Search <String[]>]
 [-Filter <NameValueCollection>] [-Count <UInt16>] [-Page <UInt32>] [-All] [<CommonParameters>]
```
