...
# New-AnsibleWorkflowJobTemplate
...
```
New-AnsibleWorkflowJobTemplate -Name <String> [-Description <String>] [-Organization <UInt64>]
 [-Inventory <UInt64>] [-Limit <String>] [-ScmBranch <String>] [-ExtraVars <String>] [-Tags <String>]
 [-SkipTags <String>] [-AskScmBranch] [-AskVariables] [-AskLimit] [-AskTags] [-AskSkipTags] [-AskInventory]
 [-AskLabels] [-SurveyEnabled] [-WebhookService <String>] [-WebhookCredential <UInt64>] [-AllowSimultaneous]
...
### Example 1
```powershell
PS C:\> New-AnsibleWorkflowJobTemplate -Name DemoFlow1 -Organization 1
```
