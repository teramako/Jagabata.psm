...
```
Find-AnsibleNotificationTemplateForSuccess [-Type] <ResourceType> [-Id] <UInt64> [-OrderBy <String[]>]
...
### Example 1
```powershell
PS C:\> Find-AnsibleNotificationTemplateForSuccess -Type Organization -Id 1
```
