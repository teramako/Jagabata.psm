...
```
Find-AnsibleNotificationTemplateForStarted [-Type] <ResourceType> [-Id] <UInt64> [-OrderBy <String[]>]
...
### PipelineInput
```
Find-AnsibleNotificationTemplateForStarted [-Resource] <IResource> [-OrderBy <String[]>] [-Search <String[]>]
 [-Filter <NameValueCollection>] [-Count <UInt16>] [-Page <UInt32>] [-All] [<CommonParameters>]
```

## DESCRIPTION
Retrieve the list of Started NotificationTemplates enabled in the Organization or Template
...
### Example 1
```powershell
PS C:\> Find-AnsibleNotificationTemplateForStarted -Type Organization -Id 1
```

Retrieve Started NotificationTemplates enabled in the Organization of ID 1.
