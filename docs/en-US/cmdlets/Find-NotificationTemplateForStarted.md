...
```
Find-NotificationTemplateForStarted [-Type] <ResourceType> [-Id] <UInt64> [-OrderBy <String[]>]
...
### PipelineInput
```
Find-NotificationTemplateForStarted [-Resource] <IResource> [-OrderBy <String[]>] [-Search <String[]>]
...
### Example 1
```powershell
PS C:\> Find-NotificationTemplateForStarted -Type Organization -Id 1
```
