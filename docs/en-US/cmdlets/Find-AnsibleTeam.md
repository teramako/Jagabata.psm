...
### All (Default)
```
Find-AnsibleTeam [-OrderBy <String[]>] [-Search <String[]>] [-Filter <NameValueCollection>] [-Count <UInt16>]
 [-Page <UInt32>] [-All] [<CommonParameters>]
```

### AssociatedWith
```
Find-AnsibleTeam [-Type] <ResourceType> [-Id] <UInt64> [-OrderBy <String[]>] [-Search <String[]>]
...
### Example 2
```powershell
PS C:\> Find-AnsibleTeam -Type Organization -Id 1
```
