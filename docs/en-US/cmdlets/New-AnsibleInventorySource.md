...
```
New-AnsibleInventorySource -Name <String> [-Description <String>] -Inventory <UInt64>
...
### Example 1
```powershell
PS C:\> New-AnsibleInventorySource -Name DemoSource -Inventory 1 -Source Scm -SourceProject 10 -SourcePath inventory/hosts.ini
```
